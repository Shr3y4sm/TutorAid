...
function Chat({ currentUser, targetUser, messages, onSend }: ChatProps) {
  ...
  return (
    <View style={styles.container}>
            ...
            messages.map((message, index) => (
              <View
                ...
                style={[
                  ...
                  message.sender === currentUser ? styles.messageOutgoing : styles.messageIncoming,
                ]}
              >
      ...
      <View style={styles.inputRow}>
        ...
        />
        <Pressable style={[styles.sendButton, !targetUser && styles.sendButtonDisabled]} onPress={handleSend} disabled={!targetUser}>
